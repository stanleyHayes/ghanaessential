...
The canonical web hostname is `essential.digitalghana.dev`. Additional API or operational hostnames require an explicit ADR and portfolio registry entry before deployment.
